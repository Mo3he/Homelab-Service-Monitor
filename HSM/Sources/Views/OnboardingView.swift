...
struct OnboardingView: View {
    ...
    private let pages: [(icon: String, color: Color, title: String, body: String)] = [
        (
            "server.rack",
            .blue,
            "Welcome to Homelab Service Monitor",
        ...
        (
            ...
            .green,
            "Add Your Services",
            "Tap + and pick a service type. HSM auto-detects the right API and pre-fills the port. Just enter your host and any credentials."
        ),
        (
            "chart.line.uptrend.xyaxis",
            .purple,
            "Live Metrics",
            "For supported services like AdGuard, Grafana, Portainer and more, HSM fetches live stats directly from the API."
        ),
        (
